...
class ViaUAudioProcessorEditor : public juce::AudioProcessorEditor, private juce::Timer
{
public:
...
private:
    ...
    // Gradient helper
    juce::Colour interpolateColour(float vu, float vuStart, float vuEnd, juce::Colour startCol, juce::Colour endCol);
